...
export const ideaDraftSchema = z.object({
  ...
  problemStatement: z
    .string({ required_error: "Problem Statement is required!" })
    .trim()
    .min(15, "Problem statement must be at least 15 characters!").optional(),

  solution: z
    .string({ required_error: "Solution is required!" })
    .trim()
    .min(20, "Solution must be at least 20 characters long!").optional(),

  description: z
    .string({ required_error: "Description Statement is required!" })
    .trim()
    .min(20, "Description must be 20 characters long!").optional(),

  price: z
    .number({ required_error: "Price is required!" })
    .nonnegative("Price is must a positive value!").optional(),
