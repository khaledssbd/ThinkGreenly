  ...
  return (
    <div>
      {isLoading ? (
        ...
        <div className="w-full h-[400px] border-2 rounded-2xl py-3 border-green-600">
          <div>
            <p className="font-bold mt-4 mb-10 ml-10">Bar Chart</p>
          </div>
          <ChartContainer config={chartConfig} className="h-[270px] w-full">
            <BarChart accessibilityLayer data={formattedChartData} barGap={8} barCategoryGap="20%">
              ...
              <Bar dataKey="count" fill="#067136" radius={4} barSize={60} />
              <Bar dataKey="AvgCount" fill="#A3C664" radius={4} barSize={60} />
            </BarChart>
          </ChartContainer>
        </div>
      )}
